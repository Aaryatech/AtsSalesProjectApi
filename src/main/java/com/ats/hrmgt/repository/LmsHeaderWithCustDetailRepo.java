...
public interface LmsHeaderWithCustDetailRepo extends JpaRepository<LmsHeaderWithNamesAndCustDetail, Integer> {
	...
	@Query(value="SELECT\n" + 
			"        lms_header.*,\n" + 
			"        '' as account_type,\n" + 
			"        concat(m_city.m_city_name ,',',m_states.m_state_name) AS city_state,\n" + 
			...
			"        concat(lms_detail.cp_mobile,\n" + 
			"        ',',\n" + 
			"        lms_detail.cp_email) as cp_contact,\n" + 
			"        concat(lms_header.acc_company,\n" + 
			"        ',',\n" + 
			"        m_domain_type.m_domain_name) as cp_info2     \n" + 
			"    FROM\n" + 
			"        lms_header,\n" + 
			"        m_channel,\n" + 
			"        lms_detail,\n" + 
			...
			"        AND lms_header.m_state_id=m_states.m_state_id\n" + 
			"        AND lms_header.m_city_id=m_city.m_city_id\n" + 
			"    GROUP BY\n" + 
